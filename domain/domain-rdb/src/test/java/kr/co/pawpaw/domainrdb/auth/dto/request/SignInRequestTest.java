...
import helper.SignInRequestBuilder;
...
class SignInRequestTest {
    ...
    void validationTest() {
        //given
        SignInRequest request1 = SignInRequestBuilder.builder().build();
        List<String> violationPropertyPaths1 = List.of("id", "password");
        SignInRequest request2 = SignInRequestBuilder.builder()
            .id("id")
            .password("password")
            .build();
